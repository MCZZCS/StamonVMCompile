...
public class DivMovNode extends OpNode{
    ...
    public void executor(Executor executor) throws VMRuntimeException {
        ...
        else if(t1.getType()== SVMObject.NULL||t2.getType()== SVMObject.NULL)throw new VMRuntimeException("除法运算时发生空指针异常",executor.getThread(), VMRuntimeException.EnumVMException.NULL_PRINT_EXCEPTION);
        else{
