...
public class DivXNode extends OpNode{
    ...
    public void executor(Executor executor) throws VMRuntimeException {
        ...
        if(t1.getType()== SVMObject.STRING||t2.getType()== SVMObject.STRING||t1.getType()== SVMObject.BOOLEAN||t2.getType()== SVMObject.BOOLEAN)throw new VMRuntimeException("字符串或布尔值类型不能参加取余运算",executor.getThread(), VMRuntimeException.EnumVMException.ILLEGAL_STATE_EXCEPTION);
