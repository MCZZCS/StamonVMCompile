...
public class MulNode extends OpNode {
    ...
    public void executor(Executor executor) throws VMRuntimeException {
        ...
        if(t1.getType()== SVMObject.STRING||t2.getType()== SVMObject.STRING||t1.getType()== SVMObject.BOOLEAN||t2.getType()== SVMObject.BOOLEAN)throw new VMRuntimeException("字符串或布尔值类型不能参加乘法运算",executor.getThread());
        ...
        else if(t1.getType()== SVMObject.NULL||t2.getType()== SVMObject.NULL)throw new VMRuntimeException("乘法运算时发生空指针异常",executor.getThread());
        else{
